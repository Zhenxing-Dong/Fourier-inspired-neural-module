...
######### Logs dir ###########
log_dir = os.path.join(opt.save_dir, 'full_channel', 'rgb', opt.arch + opt.env)
...
criterion_WFFT = provider.get_loss_function('watson-fft', deterministic=False, colorspace='RGB',
...
for epoch in range(start_epoch, opt.nepoch + 1):
    ...
    for i, target in enumerate(train_loader, 0): 
        ...
        # Hologram generation
        slm_phase = phase_generator(target_amp)
