...
wavelengths = (638*nm, 543*nm, 450*nm)  # wavelength of each color
...
image_res = (1072, 1920)
roi_res = (1072, 1920)  # regions of interest (to penalize)
...
for k, target in enumerate(image_loader):
    ...
    for c in chs:
        ...
        recon_phase_c = recon_field.angle()
        ...
        recon_phase.append(recon_phase_c)
